...
public:
    ...
    sensor_msgs::Imu imuConverter(const sensor_msgs::Imu& imu_in)
    {
        ...
        Eigen::Vector3d rpy = q_final.toRotationMatrix().eulerAngles(2, 1, 0);
        ...
        imu_out.orientation.x = q_final_new.x();
        imu_out.orientation.y = q_final_new.y();
        imu_out.orientation.z = q_final_new.z();
        imu_out.orientation.w = q_final_new.w();
